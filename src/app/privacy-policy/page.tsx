      ...
      <div className="min-h-screen bg-white dark:bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
          ...
          <div className="mb-12 text-left">
            <h1 className="text-5xl font-medium text-gray-900 dark:text-white mb-4 font-ibm-plex-sans">
              Privacy Policy
            </h1>
          </div>
          ...
          <div className="mb-12 p-6 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 font-sans">
              Who we are
            </h2>
            <p className="text-gray-700 dark:text-gray-300 font-sans mb-2">
          ...
          <div className="space-y-8">
            ...
            <section className="pb-6 border-b border-gray-200 dark:border-gray-800">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 font-sans">
                A1. What we collect on the website
              </h2>
              <ul className="space-y-3 text-gray-700 dark:text-gray-300 font-sans leading-relaxed">
              ...
              <p className="mt-4 text-gray-700 dark:text-gray-300 font-sans font-semibold">
            ...
            <section className="pb-6 border-b border-gray-200 dark:border-gray-800">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 font-sans italic">
            ...
            <section className="pb-6 border-b border-gray-200 dark:border-gray-800">
              ...
              <div className="space-y-3 text-gray-700 dark:text-gray-300 font-sans leading-relaxed">
                <p>
