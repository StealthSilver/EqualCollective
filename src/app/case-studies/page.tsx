                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="p-6 md:p-8">
                      {/* Case Study ID */}
                      <div className="text-xs font-semibold text-orange-600 dark:text-orange-400 mb-3 tracking-wider">
                        {study.id}
                      </div>
                      ...
                      {/* Read More Button */}
                      <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-[0_0_20px_rgba(249,115,22,0.4)] transform hover:-translate-y-0.5">
